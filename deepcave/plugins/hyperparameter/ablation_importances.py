...
class AblationImportances(StaticPlugin):
    """
    ...
    id = "ablation_importances"
    name = "Ablation Importances"
    icon = "far fa-star-half-alt"
    help = "docs/plugins/ablation_importances.rst"
                    ...
                    dbc.Col(
                        [
                            ...
                            help_button(
                                ...
                                "hyperparameter ablation importance. "
    ...
    def load_outputs(run, inputs, outputs) -> go.Figure:  # type: ignore
        ...
        figure.update_layout(
            barmode="group",
            yaxis_title="Ablation Importances",
            legend={"title": "Budget"},
            margin=config.FIGURE_MARGIN,
            xaxis=dict(tickangle=-45),
            font=dict(size=config.FIGURE_FONT_SIZE),
        )
        save_image(figure, "ablation_importances.pdf")
